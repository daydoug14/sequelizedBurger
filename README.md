...
In this assignment, you're going to Sequelize the `Burger` app you made last week. We've split this exercise into three different tiers, all with different wishes and expectations. Finish whichever tier will provide you with the most reasonable challenge.
